...
<div class="max-w-3xl mx-auto space-y-8">
    ...
    <form action="{{ route('admin.assessments.store') }}" method="POST" 
        ...
        <div data-aos="fade-up" data-aos-delay="250"> 
            ...
            @error('title')
                <p class="text-destructive text-sm mt-1 animate-fade-in">{{ $message }}</p>
            @enderror
        </div>
        ...
        {{-- ===== Submit Button ===== --}}
        <div class="pt-4 flex justify-end" data-aos="fade-up" data-aos-delay="450">
            <button type="submit"
...
document.addEventListener('DOMContentLoaded', () => {
    if (window.AOS) {
        ...
        console.log("✅ AOS initialized on Create Assessment page");
    } else {
        console.error("❌ AOS not loaded — check layouts.admin");
    }
});
</script>
@endpush

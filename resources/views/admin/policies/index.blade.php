...
<div class="p-6 space-y-6">
    ...
    <div class="flex justify-between items-center" data-aos="fade-up">
        <div>
            <h1 class="text-2xl font-bold text-foreground">Policies</h1>
            <p class="text-muted-foreground text-sm">Manage and review all organizational policies</p>
        </div>
    ...
    {{-- ===== Data Table ===== --}}
    <div id="policies-table" data-aos="fade-up" data-aos-delay="150">
        @include('admin.policies.partials.table')
    </div>
</div>
@endsection
...
document.addEventListener('DOMContentLoaded', () => {
    const tableDiv = document.querySelector('#policies-table');
    ...
    function fetchData() {
        ...
        fetch(`{{ route('admin.policies.index') }}?${query}`, {
